...
- CH1 Knob: Root of Step 1 Chord, Note 1 - 16 (C3 - C6 in C Major Pentatonic Scale)
...
- CH5 Knob: Arpeggio Pattern, 1 - 8
    - Pattern 1,  9: 1 + 3 + 5 + 7, Up
    - Pattern 2, 10: 1 + 3 + 5 + 7, Up & Down
    - Pattern 3, 11: 1 + 5 + 7 + 8, Up
    - Pattern 4, 12: 1 + 5 + 7 + 8, Up & Down
    - Pattern 5, 13: 1 + 5 + 6 + 8, Up
    - Pattern 6, 14: 1 + 5 + 6 + 8, Up & Down
    - Pattern 7, 15: 1 + 3 + 5 + 6, Up
    - Pattern 8, 16: 1 + 3 + 5 + 6, Up & Down
...
- Version 0.1.0 (2026-04-19): Initial release

License
-------

MIDI Controller PRMC-1 (type-5) by ISGK Instruments (Ryo Ishigaki) is marked with CC0 1.0.
