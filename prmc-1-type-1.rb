...
- mruby compiler 3.3.0 (mrubyコンパイラ3.3.0) https://www.s-itoc.jp/support/technical-support/mrubyc/mrubyc-download/
    - Please run `prmc-1-type-1.mrb` on R2P2, which is output by running `mrbc prmc-1-type-1.rb` on a PC or Mac
    - If you run `prmc-1-type-1.rb` on R2P2, an out of memory error will occur
